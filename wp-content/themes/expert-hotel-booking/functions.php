...
define( 'EXPERT_HOTEL_BOOKING_PARENT_INC_URI', EXPERT_HOTEL_BOOKING_PARENT_URI . '/inc');
	 ...
	 */
	load_theme_textdomain( 'expert-hotel-booking' );
    ...
    <div class="updated notice notice-get-started-class is-dismissible" data-notice="get_started">
        <div class="expert-hotel-booking-getting-started-notice clearfix">
            <div class="expert-hotel-booking-theme-notice-content">
                ...
                <a class="expert-hotel-booking-btn-get-started button button-primary button-hero expert-hotel-booking-button-padding" href="<?php echo esc_url(admin_url('themes.php?page=expert-hotel-booking-about')); ?>"><?php esc_html_e('Get started', 'expert-hotel-booking') ?></a><span class="expert-hotel-booking-push-down">
            </div>
        </div>
    </div>
    <?php
...
add_action('wp_ajax_dismiss_expert_hotel_booking_notice', 'dismiss_expert_hotel_booking_notice');

// Reset the dismissed status when the theme is activated
function reset_expert_hotel_booking_notice_status() {
    delete_option('expert_hotel_booking_notice_dismissed');
}
add_action('after_switch_theme', 'reset_expert_hotel_booking_notice_status');

function dismiss_expert_hotel_booking_notice() {
