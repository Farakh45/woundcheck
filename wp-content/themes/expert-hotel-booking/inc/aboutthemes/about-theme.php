...
if ( ! defined( 'EXPERT_HOTEL_BOOKING_FREE_THEME_URL' ) ) {
	define( 'EXPERT_HOTEL_BOOKING_FREE_THEME_URL', 'https://www.seothemesexpert.com/wordpress/free-hotel-wordpress-theme/' );
}
if ( ! defined( 'EXPERT_HOTEL_BOOKING_PRO_THEME_URL' ) ) {
	define( 'EXPERT_HOTEL_BOOKING_PRO_THEME_URL', 'https://www.seothemesexpert.com/wordpress/hotel-booking-wordpress-theme/' );
}
if ( ! defined( 'EXPERT_HOTEL_BOOKING_DEMO_THEME_URL' ) ) {
	define( 'EXPERT_HOTEL_BOOKING_DEMO_THEME_URL', 'https://seothemesexpert.com/demo/hotel-booking-expert/' );
}
if ( ! defined( 'EXPERT_HOTEL_BOOKING_DOCS_THEME_URL' ) ) {
    define( 'EXPERT_HOTEL_BOOKING_DOCS_THEME_URL', 'https://www.seothemesexpert.com/docs/expert-hotel-booking-website-template-pro/' );
}
		...
		<div class="main-col-box">
			<div class="feature-section two-col">
				<div class="card">
					...
					<p><a href="<?php echo esc_url( EXPERT_HOTEL_BOOKING_PRO_THEME_URL ); ?>" class="button button-primary"><?php esc_html_e( 'Upgrade Pro', 'expert-hotel-booking' ); ?></a></p>
				</div>

				<div class="card">
					<h2 class="title"><?php esc_html_e( 'Theme Info', 'expert-hotel-booking' ); ?></h2>
					<p><?php esc_html_e( 'Know more about film studio.', 'expert-hotel-booking' ) ?></p>
					<p><a href="<?php echo esc_url( EXPERT_HOTEL_BOOKING_FREE_THEME_URL ); ?>" class="button button-primary"><?php esc_html_e( 'Theme Info', 'expert-hotel-booking' ); ?></a></p>
				</div>
				...
				<div class="card">
					...
					<p><a href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Customize', 'expert-hotel-booking' ); ?></a></p>
				</div>
				...
				<div class="card">
					...
					<p><a href="<?php echo esc_url( EXPERT_HOTEL_BOOKING_SUPPORT_THEME_URL ); ?>" class="button button-primary"><?php esc_html_e( 'Support Forum', 'expert-hotel-booking' ); ?></a></p>
				</div>
				...
				<div class="card">
					...
					<p><a href="<?php echo esc_url( EXPERT_HOTEL_BOOKING_RATE_THEME_URL ); ?>" class="button button-primary"><?php esc_html_e( 'Rate Us', 'expert-hotel-booking' ); ?></a></p>
				</div>		
			</div>
				...
				<table>
					...
					<tbody>
						...
						<tr class="odd" scope="row">
							...
							<td class="feature feature--empty"></td>
							<td headers="comp-2" class="td-btn-2"><a class="sidebar-button single-btn protheme button button-secondary" href="<?php echo esc_url(EXPERT_HOTEL_BOOKING_PRO_THEME_URL);?>"><?php esc_html_e( 'Go for Premium', 'expert-hotel-booking' ); ?></a></td>
						</tr>
					</tbody>
				</table>
			</div>
